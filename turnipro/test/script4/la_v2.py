...
head_list = ["学号","挂科数","科目数","挂科率","消费起始时间","消费终止时间","学期消费总金额","总次数","总天数","日均消费次数","日均消费金额","次均消费金额","早消费总金额","早消费总次数","早消费总天数","早日均消费次数","早日均消费金额","早次均消费金额","早金额比重","早次数比重","早天数比重","中消费总金额","中消费总次数","中消费总天数","中日均消费次数","中日均消费金额","中次均消费金额","中金额比重","中次数比重","中天数比重","晚消费总金额","晚消费总次数","晚消费总天数","晚日均消费次数","晚日均消费金额","晚次均消费金额","晚金额比重","晚次数比重","晚天数比重"]
...
csv_file1 = file('count_info_with_score_v3_v1_2013.01.csv', 'wb')
csv_file2 = file('count_info_with_score_v3_v1_2013.09.csv', 'wb')
csv_file3 = file('count_info_with_score_v3_v1_2014.01.csv', 'wb')
csv_file4 = file('count_info_with_score_v3_v1_2014.09.csv', 'wb')
file_object1 = csv.writer(csv_file1, dialect='excel')
file_object2 = csv.writer(csv_file2, dialect='excel')
file_object3 = csv.writer(csv_file3, dialect='excel')
file_object4 = csv.writer(csv_file4, dialect='excel')
file_object1.writerow(head_list)
file_object2.writerow(head_list)
file_object3.writerow(head_list)
file_object4.writerow(head_list)
