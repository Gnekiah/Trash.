...
for filename in all_csv_files:
    ...
    with open(filename, 'rb') as read_file:
        ...
        for row in read_in:
            ...
            # 判断学期
            if (which_day > "2013/08/01" and which_day < "2013/09/01") or (which_day > "2014/02/01" and which_day < "2014/03/01") or (which_day > "2014/08/01" and which_day < "2014/09/01") or (which_day > "2015/02/01" and which_day < "2015/03/01"):
                pass
            
            elif which_day > date_2012_9 and which_day < date_2013_1:
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_1:
                        pass
                    else:
                        breakfast_list_1.append(which_day)
                    ...
                    if which_day in lunch_list_1:
                        pass
                    else:
                        lunch_list_1.append(which_day)
                        lunch_days_count_12_09 += 1
                    lunch_times_count_12_09 += 1
                else:
                    dinner_sumup_12_09 -= float(row[-1])
                    if which_day in dinner_list_1:
                        pass
                    else:
                        dinner_list_1.append(which_day)
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_2:
                        pass
                    else:
                        breakfast_list_2.append(which_day)
                        breakfast_days_count_13_01 += 1
                    breakfast_times_count_13_01 += 1
                elif which_time >= breakfast_lunch and which_time < lunch_dinner:
                    lunch_sumup_13_01 -= float(row[-1])
                    if which_day in lunch_list_2:
                        pass
                    else:
                        lunch_list_2.append(which_day)
                        lunch_days_count_13_01 += 1
                    lunch_times_count_13_01 += 1
                else:
                    dinner_sumup_13_01 -= float(row[-1])
                    if which_day in dinner_list_2:
                        pass
                    else:
                        dinner_list_2.append(which_day)
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_3:
                        pass
                    else:
                        breakfast_list_3.append(which_day)
                        breakfast_days_count_13_09 += 1
                    breakfast_times_count_13_09 += 1
                elif which_time >= breakfast_lunch and which_time < lunch_dinner:
                    lunch_sumup_13_09 -= float(row[-1])
                    if which_day in lunch_list_3:
                        pass
                    else:
                        lunch_list_3.append(which_day)
                        lunch_days_count_13_09 += 1
                    lunch_times_count_13_09 += 1
                else:
                    dinner_sumup_13_09 -= float(row[-1])
                    if which_day in dinner_list_3:
                        pass
                    else:
                        dinner_list_3.append(which_day)
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_4:
                        pass
                    else:
                        breakfast_list_4.append(which_day)
                        breakfast_days_count_14_01 += 1
                    breakfast_times_count_14_01 += 1
                elif which_time >= breakfast_lunch and which_time < lunch_dinner:
                    lunch_sumup_14_01 -= float(row[-1])
                    if which_day in lunch_list_4:
                        pass
                    else:
                        lunch_list_4.append(which_day)
                        lunch_days_count_14_01 += 1
                    lunch_times_count_14_01 += 1
                else:
                    dinner_sumup_14_01 -= float(row[-1])
                    if which_day in dinner_list_4:
                        pass
                    else:
                        dinner_list_4.append(which_day)
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_5:
                        pass
                    else:
                        breakfast_list_5.append(which_day)
                        breakfast_days_count_14_09 += 1
                    breakfast_times_count_14_09 += 1
                elif which_time >= breakfast_lunch and which_time < lunch_dinner:
                    lunch_sumup_14_09 -= float(row[-1])
                    if which_day in lunch_list_5:
                        pass
                    else:
                        lunch_list_5.append(which_day)
                        lunch_days_count_14_09 += 1
                    lunch_times_count_14_09 += 1
                else:
                    dinner_sumup_14_09 -= float(row[-1])
                    if which_day in dinner_list_5:
                        pass
                    else:
                        dinner_list_5.append(which_day)
                ...
                if which_time < breakfast_lunch:
                    ...
                    if which_day in breakfast_list_6:
                        pass
                    else:
                        breakfast_list_6.append(which_day)
                        breakfast_days_count_15_01 += 1
                    breakfast_times_count_15_01 += 1
                elif which_time >= breakfast_lunch and which_time < lunch_dinner:
                    lunch_sumup_15_01 -= float(row[-1])
                    if which_day in lunch_list_6:
                        pass
                    else:
                        lunch_list_6.append(which_day)
                        lunch_days_count_15_01 += 1
                    lunch_times_count_15_01 += 1
                else:
                    dinner_sumup_15_01 -= float(row[-1])
                    if which_day in dinner_list_6:
                        pass
                    else:
                        dinner_list_6.append(which_day)
