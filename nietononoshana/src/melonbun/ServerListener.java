...
public class ServerListener extends Thread {
    ...
    public static final String ACCEPT_FILE_PATH = "D:/ACCEPT_PATH/";
    public static String PUBLIC_KEY_FILE = ACCEPT_FILE_PATH + "PublicKey";
    ...
    public ServerListener(Queue<FileInfo> queue) {
        this.queue = queue;
